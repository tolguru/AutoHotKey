...
TemplateMatch(ByRef Out_X, ByRef Out_Y, Find_X1, Find_Y1, Find_X2, Find_Y2, SearchImage, Method:="TM_SQDIFF")
{
	Module := DllCall("LoadLibrary", "Str", "OpenCVTemplateMatch_x64.dll")
	maxVal := DllCall("OpenCVTemplateMatch_x64.dll\TemplateMatch"
										, "int*", Out_X, "int*", Out_Y
